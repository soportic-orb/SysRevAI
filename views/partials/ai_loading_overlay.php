...
/**
 * Centred full-screen "AI is working" overlay. Rendered once by
 * layouts/app.php (and layouts/admin.php) and shown via JS whenever a
 * form annotated with data-ai-action submits, or any code calls the
 * global SysRevAI.showAiOverlay() helper.
 *
 * Hidden by default — visibility is toggled by the .is-visible class
 * (we rely on the global [hidden] rule for the initial state).
 */
?>
<div class="ai-overlay" id="aiOverlay" hidden aria-live="polite" aria-busy="true" role="status">
    <div class="ai-overlay__card">
        <svg class="ai-overlay__icon" viewBox="0 0 24 24" width="64" height="64"
